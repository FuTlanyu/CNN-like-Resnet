...
python CAMELYON16/camelyon16/bin/train.py
E:\python\program\dachuang_heatmap\configs\cnn.json
E:\python\program\dachuang_heatmap\save\resnet18-save
其中/cnn_path/cnn.json包含了训练所需要的配置文件，/SAVE_PATH是您保存训练结果的文件夹。
'''
# batch size 10 -> 20
...
from bin.image_producer import ImageDataset
torch.manual_seed(0)
...
def train_epoch(summary, summary_writer, cnn, model, loss_fn, optimizer,
    ...
    for step in range(steps):
        ...
        # when step = 102 data_train.shape() = torch.Size([1, 3, 256, 256])
